...
function onInit(){
    try {
        ...
        if (e == 2) {
            updateStatus("错误提示: 无效的数据库版本。");
        }
        else {
            updateStatus("错误提示:未知错误 " + e + ".");
        }
        return;
    }
}
...
function createTables(){
    ...
    try {
        localDB.transaction(function(transaction){
            ...
            updateStatus("目前，数据表中有");
        });
    } 
    catch (e) {
        updateStatus("错误提示: 无法创建数据表" + e + ".");
        return;
    }
}
