	...
	<el-row class="tac">
		...
		<el-col :span="24" class="selectField">
			...
			<el-col :span="24" class="timeBt clearfix dimensionFild">
				...
				<!--<el-select v-model="dimensions" filterable placeholder="请选择" class="dimensionsClass">
    				<el-option v-for="(item,index) in dimensionList" :key="item.value" :label="item.label" :value="item.value"></el-option>
  			</el-select>-->
  				<search-select :allFlag="true" :changeList="changeListTime" :items="dimensionList" v-model="dimensionList.chosen" :commonFlag="true" :flagValue="true"></search-select>
			</el-col>
			<el-col :span="24" class="timeBt clearfix dimensionFild">
				...
				<div class="fl">
					<div class="clearfix selectFor replaceClass" v-for="(items,index) in allConLists">
	  					...
	  					<muli-select :changeList="changeListSele" v-if="items.thirdCon.selectFlag && (items.seconCon.chosen!='bh') && (items.seconCon.chosen!='nobh')" :items="items.thirdCon" v-model="items.thirdCon.transArr" :allFlag="items.seconCon.chosen == 'all'"></muli-select>
			...
			<el-col :span="24" class="timeBt clearfix dimensionFild">
				...
				<check-select :allFlag="true" :changeList="changeListChe" :items="checkSelectObj" v-model="checkSelectObj.transArr"></check-select>
			</el-col>
