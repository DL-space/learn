	...
	<div class="order_wrap">
		...
		<div class="order">
			...
			<div class="amount_payment">
				...
				<p>支付货款总额：<b>￥{{receivedInfo.orderTotalMoney}}.00</b></p>
			</div>
			<div class="order_list" style="padding: 0;">
				<order-item v-if="orderList.length>0" :type="1" v-for="(item,index) of orderList" :data="item" :key="index" @jumpDetail="jumpDetail"></order-item>
...
<script>
	...
	export default {
		...
		created() {
			...
			this.$store.dispatch('setMypayGoods',{openId,page,rows,condition,startEndType});
		},
		computed: mapState({
